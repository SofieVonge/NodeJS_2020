...
friends.push({"name": "oneFriend"}, {"name": "friend2"}, {"name": "friend3"});
console.log(friends);
// --------------------------------------
...
//splice(start, howManyToDelete, insertedItems)
...
//løsning 2, spread operator, unpacking the elements
var dinnerTray = [...diet];
console.log("new dinnerTray", dinnerTray);
// --------------------------------------
